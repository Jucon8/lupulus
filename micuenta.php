...
<body>
  ...
  <div class="container-fluid " id="formularioGeneral">
    <div class="container-fluid pt-5 pb-5" id="fondo">
              ...
              <form>
                <div class="form-row">
                  ...
                  <div class="col-xs-12 col-md-6 pb-3">
                    ...
                    <button class="btn btn-md btn-danger" type="reset"><i class="icon ion-md-refresh"></i> Limpiar</button>
                  </div>
                </div>
              </form>
            </div>
