    ...
    <div class="carousel slide container" data-ride="carousel" id="carouselFull" style="height:50%; width: 50%;">
      ...
      <div class="carousel-inner" id="slide-chico">
        <div class="carousel-item active">
          <img class="img-fluid d-block" src="img/birrabarril.jpg" alt="First slide" max-width="100%" height="auto">
          <div class="carousel-caption d-none d-md-block d-lg-block">
            <h3>Barriles de Madera</h3>
          </div>
        </div>
        <div class="carousel-item">
          <img class=" img-fluid d-block" src="img/barriles1.jpg" alt="Second slide" max-width="100%" height="auto">
          <div class="carousel-caption d-none d-md-block d-lg-block">
            <h3>Barriles de Acero</h3>
          </div>
        </div>
        <div class="carousel-item">
          <img class="img-fluid d-block" src="img/botellasverdes.jpg" alt="Third slide" max-width="100%" height="auto">
          <div class=" carousel-caption d-none d-md-block d-lg-block">
