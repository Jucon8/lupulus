...
<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark " tyle="background-color: #000;">
    <a class="navbar-brand p-0 pt-2" href="index" style="background-color: transparent; width:15%; box-shadow: none;">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" style="text-transform: capitalize" href="index#nosotros">Nosotros</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" style="text-transform: capitalize" href="index#preguntas">FAQs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" style="text-transform: capitalize" href="shop">Shop</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" style="text-transform: capitalize" href="index#contacto">Contacto</a>
            </li>
        </ul>
        <ul class="navbar-nav">
          ...
          <?php endif; ?>
           ...
           <div class="dropdown-menu dropdown-open" aria-labelledby="navbarDropdown">
             ...
             <a class="dropdown-item text-danger" style="text-transform: capitalize" href="logout"> Cerrar sesión </a>
           </div>
           <?php endif;?>
...
<footer id="footer">
    <div class="flex-container">
        ...
        <div>  <a href="index"> <img src="/img/lupulo.svg" class="img-top" alt="logo"></a> </div>
